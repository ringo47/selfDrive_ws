...
// (in-package spinnaker_sdk_camera_driver.msg)
...
class SpinnakerImageNames {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SpinnakerImageNames(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SpinnakerImageNames(null);
...
module.exports = SpinnakerImageNames;
